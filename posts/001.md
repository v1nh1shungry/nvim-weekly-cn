...
主要聚焦的是 justinmk 作为核心维护者代表的 Neovim 开发团队对未来发展趋势的见解和开发目标，
...
* 一些确定希望实现的小目标，有点多，具体情况还是看文章吧。
* 统计到的 Neovim 的下载量翻一番！赢！
* Neovim 不需要收集遥测数据，开发团队从 Github Issues、社交媒体和个人直觉就能获得不少反馈。所以大家有问题一定记得去 Issues 或者 Discussion 留言。
